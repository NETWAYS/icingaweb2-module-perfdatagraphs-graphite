...
final class TransformerTest extends TestCase
{
    ...
    public function test_transform()
    {
        ...
        $expected = '{"errors":[],"data":[{"title":"available_upgrades","unit":"","show_thresholds":true,"timestamps":[1731838620,1731838680,1731838740,1731838800,1731838860],"series":[{"name":"value","values":[626,626,626,626,626]}]},{"title":"critical_updates","unit":"","show_thresholds":true,"timestamps":[1731838620,1731838680,1731838740,1731838800,1731838860],"series":[{"name":"value","values":[211,211,211,211,211]}]}]}';
    ...
    public function test_transform_with_emtpy()
    {
        ...
        $actual = Transformer::transform($input);
        $expected = '{"errors":[],"data":[{"title":"rta","unit":"","show_thresholds":true,"timestamps":[1731848460,1731848520,1731848580,1731848640,1731848700],"series":[{"name":"value","values":[7,5,8,7,null]},{"name":"warning","values":[3,3,3,3,null]},{"name":"critical","values":[5,5,5,5,null]}]}]}';
    ...
    public function test_transform_with_warn_and_crit()
    {
        ...
        $expected = '{"errors":[],"data":[{"title":"pl","unit":"","show_thresholds":true,"timestamps":[1731848460,1731848520,1731848580,1731848640,1731848700],"series":[{"name":"value","values":[0,0,0,0,null]},{"name":"warning","values":[80,80,80,80,null]},{"name":"critical","values":[100,100,100,100,null]}]},{"title":"rta","unit":"","show_thresholds":true,"timestamps":[1731848460,1731848520,1731848580,1731848640,1731848700],"series":[{"name":"value","values":[7,5,8,7,null]},{"name":"warning","values":[3,3,3,3,null]},{"name":"critical","values":[5,5,5,5,null]}]}]}';
